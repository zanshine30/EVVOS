...
pip install aiohttp gpiozero RPi.GPIO
...
try:
    ...
    Button = None
    print("WARNING: gpiozero not available. Button reset feature disabled.")
...
class EVVOSWiFiProvisioner:
    ...
    def __init__(self):
        ...
        # Setup button handler (ReSpeaker HAT physical button on GPIO 17)
