...
chown -R $TARGET_USER "$EVVOS_DIR" 2>/dev/null || true
...
chown $TARGET_USER "$APP_DIR/app.py" 2>/dev/null || true
...
chown $TARGET_USER "$SCRIPTS_DIR/start_ap.sh" 2>/dev/null || true
...
chown $TARGET_USER "$SCRIPTS_DIR/stop_ap.sh" 2>/dev/null || true
...
chown $TARGET_USER "$SCRIPTS_DIR/evvos_boot.sh" 2>/dev/null || true
